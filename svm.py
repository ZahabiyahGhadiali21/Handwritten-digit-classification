...
def train_svm_classifier(train_img, train_labels, test_size=0.2, gamma=0.1, kernel='poly'):
...
def visualize_test_images(test_img, test_labels, test_labels_pred, num_images=15):
...
if __name__ == "__main__":
    ...
    clf, X_val, y_val = train_svm_classifier(train_img, train_labels)
    ...
    save_classifier(clf, 'MNIST_SVM.pickle')
    clf_loaded = load_classifier('MNIST_SVM.pickle')
